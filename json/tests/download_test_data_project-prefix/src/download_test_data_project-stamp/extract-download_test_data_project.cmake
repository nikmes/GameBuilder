...
#
get_filename_component(filename "C:/Users/nikme/source/repos/GameBuilder/json/tests/download_test_data_project-prefix/src/v3.1.0.zip" ABSOLUTE)
get_filename_component(directory "C:/Users/nikme/source/repos/GameBuilder/json/test_files" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-download_test_data_project${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-download_test_data_project${i}")
